...
const userTypeWrapper = document.getElementById("userType");
...
function toggleStudentFields() {
  ...
  if (userTypeWrapper.value === "student") {
    facultyWrapper.style.display = "inline";
    yearWrapper.style.display    = "inline";
    facultySelect.required = true;   // make required for students
    yearSelect.required    = true;
  } else {
    facultySelect.value    = "";     // reset selects
    yearSelect.value       = "";
    facultyWrapper.style.display = "none";
    yearWrapper.style.display    = "none";
    facultySelect.required = false;  // not required otherwise
    yearSelect.required    = false;
  }
}
userTypeWrapper.addEventListener("change", toggleStudentFields);
...
signupForm.addEventListener("submit", async function(event) {
  ...
  try {
    ...
    await db.collection("users").doc(user.uid).set({
      ...
      email: email,
      role: userType,
      faculty: (faculty || "Not applicable"),
